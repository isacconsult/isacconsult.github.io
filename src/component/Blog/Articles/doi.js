...
const Doi = () => {
  return <div className="articol">
    ...
    <p>A fost odată un om care se mândrea cu un lucru: că rezistă.
    ...
    <p>✻</p>
    <p>Nu știa atunci că oamenii nu sunt construiți la fel.
    ...
    <p>✻</p>
    <p>Ani la rând, corpul lui a dus.
    ...
    <p>✻</p>
    <p>Creierul, însă, ținea scorul.
      Fără vorbe. Fără justificări.
    ...
    <p>✻</p>
    <p>În aceeași perioadă, a început să observe ceva și la alții.
      Unii învătau repede, ușor, păreau să prindă lucrurile din mers.
      Alții se chinuiau, uitau, se blocau, deși se străduiau.
      Mult timp crezuse că e vorba de inteligență sau de voință.
      Acum începea sa vadă altceva.
      Cei care învațau bine păreau mai liniștiți, mai așezați.
      Aveau spațiu în ei. Ceilalți erau tensionati, grăbiți, mereu în alertă.
      Nu le lipsea dorința, ci siguranța biologică.</p>
    <p>✻</p>
    <p>A înțeles atunci că învățarea nu incepe în minte, ci în creier.
    ...
    <p>✻</p>
    <p>A început să înțeleagă că mulți oameni nu sunt proști, slabi sau leneși.
    ...
    <p>✻</p>
    <p>Problema reală apare când omul interpretează această incompatibilitate ca pe un defect personal.
    ...
    <p>
      ...
      Înțelepciunea spune „mă opresc la timp". A intra înăuntru nu a fost fugă.
      A fost schimbare de ritm, schimbare de drum, respect pentru corp, liniște pentru creier.
      Pentru prima data, mintea nu a mai împins și a început să asculte.
    </p>
    <p>✻</p>
    <p>
    ...
    <p>Creierul decide.</p>
    <p>Corpul plătește.</p>
    <p>Iar înțelepciunea nu e sa te lupți cu biologia ta, ci să-ți construiesti viața în acord cu ea.</p>  
    <p>✻</p>
    <p><span className="bold_text">Nu te definește cât ai îndurat</span></p>
    <p><span className="bold_text">Te definește cât din tine a rămas.</span></p>
